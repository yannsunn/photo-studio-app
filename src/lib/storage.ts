...
class StorageManager {
  ...
  private getDefaultReferenceImages(): ReferenceImage[] {
    return [
      {
        id: 'ref-1',
        url: 'https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=400&h=400&fit=crop&bg=white',
        category: 'tops',
        description: '白Tシャツ',
        createdAt: new Date().toISOString(),
      },
      {
        id: 'ref-2',
        url: 'https://images.unsplash.com/photo-1434389677669-e08b4cac3105?w=400&h=400&fit=crop&bg=white',
        category: 'tops',
        description: 'ブラックシャツ',
        createdAt: new Date().toISOString(),
      },
      ...
      {
        id: 'ref-4',
        url: 'https://images.unsplash.com/photo-1541099649105-f69ad21f3246?w=400&h=400&fit=crop&bg=white',
        category: 'bottoms',
        description: 'ブラックパンツ',
        createdAt: new Date().toISOString(),
      },
      {
        id: 'ref-5',
        url: 'https://images.unsplash.com/photo-1556306535-0f09a537f0a3?w=400&h=400&fit=crop&bg=white',
        category: 'shoes',
        description: 'スニーカー',
        createdAt: new Date().toISOString(),
      },
      {
        id: 'ref-6',
        url: 'https://images.unsplash.com/photo-1611078489935-0cb964de46d6?w=400&h=400&fit=crop&bg=white',
